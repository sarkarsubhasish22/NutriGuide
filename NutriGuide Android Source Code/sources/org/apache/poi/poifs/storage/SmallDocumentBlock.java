...
public final class SmallDocumentBlock implements BlockWritable, ListManagedBlock {
    ...
    private SmallDocumentBlock(POIFSBigBlockSize bigBlockSize) {
    ...
    public static int fill(POIFSBigBlockSize bigBlockSize, List blocks) {
        int _blocks_per_big_block2 = getBlocksPerBigBlock(bigBlockSize);
        int count = blocks.size();
        int big_block_count = ((count + _blocks_per_big_block2) - 1) / _blocks_per_big_block2;
        int full_count = big_block_count * _blocks_per_big_block2;
    ...
    public static List extract(POIFSBigBlockSize bigBlockSize, ListManagedBlock[] blocks) throws IOException {
        ...
        for (ListManagedBlock data : blocks) {
            ...
            for (int k = 0; k < _blocks_per_big_block2; k++) {
