...
public final class DVRecord extends StandardRecord {
    ...
    public DVRecord(int validationType, int operator, int errorStyle, boolean emptyCellAllowed, boolean suppressDropDownArrow, boolean isExplicitList, boolean showPromptBox, String promptTitle, String promptText, boolean showErrorBox, String errorTitle, String errorText, Ptg[] formula1, Ptg[] formula2, CellRangeAddressList regions) {
        int i = validationType;
        int i2 = operator;
        int i3 = errorStyle;
        boolean z = emptyCellAllowed;
    ...
    public String toString() {
        ...
        sb.append("[DV]\n");
        sb.append(" options=");
        sb.append(Integer.toHexString(this._option_flags));
        sb.append(" title-prompt=");
        sb.append(formatTextTitle(this._promptTitle));
        sb.append(" title-error=");
        sb.append(formatTextTitle(this._errorTitle));
        sb.append(" text-prompt=");
        sb.append(formatTextTitle(this._promptText));
        sb.append(" text-error=");
        sb.append(formatTextTitle(this._errorText));
        sb.append("\n");
        ...
        for (int i = 0; i < nRegions; i++) {
            ...
            sb.append('(');
            sb.append(addr.getFirstRow());
            sb.append(',');
            sb.append(addr.getLastRow());
            sb.append(',');
            sb.append(addr.getFirstColumn());
            sb.append(',');
            sb.append(addr.getLastColumn());
            sb.append(')');
        }
        sb.append("\n");
        sb.append("[/DV]");
