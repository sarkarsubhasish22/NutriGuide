...
public final class EscherProperties {
    ...
    private static Map<Short, EscherPropertyMetaData> initProps() {
        ...
        addProp(m, ShapeTypes.ELLIPSE_RIBBON_2, "protection.locktext");
        addProp(m, ShapeTypes.LEFT_RIGHT_RIBBON, "protection.lockadjusthandles");
        addProp(m, ShapeTypes.VERTICAL_SCROLL, "protection.lockagainstgrouping", (byte) 1);
        addProp(m, 128, "text.textid");
        addProp(m, 129, "text.textleft");
        addProp(m, ShapeTypes.DOUBLE_WAVE, "text.texttop");
        addProp(m, ShapeTypes.PLUS, "text.textright");
        addProp(m, ShapeTypes.FLOW_CHART_PROCESS, "text.textbottom");
        addProp(m, ShapeTypes.FLOW_CHART_DECISION, "text.wraptext");
        addProp(m, ShapeTypes.FLOW_CHART_INPUT_OUTPUT, "text.scaletext");
        addProp(m, ShapeTypes.FLOW_CHART_PREDEFINED_PROCESS, "text.anchortext");
        addProp(m, ShapeTypes.FLOW_CHART_INTERNAL_STORAGE, "text.textflow");
        addProp(m, ShapeTypes.FLOW_CHART_DOCUMENT, "text.fontrotation");
        addProp(m, ShapeTypes.FLOW_CHART_MULTIDOCUMENT, "text.idofnextshape");
        addProp(m, ShapeTypes.FLOW_CHART_TERMINATOR, "text.bidir");
        addProp(m, ShapeTypes.CHART_PLUS, "text.singleclickselects");
        ...
        addProp(m, 467, "linestyle.lineestartarrowlength");
        ...
        addProp(m, 575, "shadowstyle.shadowobsured");
