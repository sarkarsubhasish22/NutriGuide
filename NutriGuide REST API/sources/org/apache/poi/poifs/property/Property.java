...
public abstract class Property implements Child, POIFSViewable {
    ...
    protected Property(int index, byte[] array, int offset) {
        byte[] bArr = new byte[128];
        this._raw_data = bArr;
        System.arraycopy(array, offset, bArr, 0, 128);
    ...
    /* access modifiers changed from: protected */
    public void setNodeColor(byte nodeColor) {
        this._node_color.set(nodeColor, this._raw_data);
    }

    /* access modifiers changed from: protected */
    public void setChildProperty(int child) {
    ...
    public Object[] getViewableArray() {
        long time = (((long) this._days_1.get()) << 32) + (((long) this._seconds_1.get()) & 65535);
        long time2 = (((long) this._days_2.get()) << 32) + (((long) this._seconds_2.get()) & 65535);
        return new Object[]{"Name          = \"" + getName() + "\"", "Property Type = " + this._property_type.get(), "Node Color    = " + this._node_color.get(), "Time 1        = " + time, "Time 2        = " + time2};
    }
