...
public final class BoundSheetRecord extends StandardRecord {
    ...
    public String toString() {
        ...
        buffer.append("    .bof        = ");
        buffer.append(HexDump.intToHex(getPositionOfBof()));
        buffer.append("\n");
        buffer.append("    .options    = ");
        buffer.append(HexDump.shortToHex(this.field_2_option_flags));
        buffer.append("\n");
        buffer.append("    .unicodeflag= ");
        buffer.append(HexDump.byteToHex(this.field_4_isMultibyteUnicode));
        buffer.append("\n");
        buffer.append("    .sheetname  = ");
        buffer.append(this.field_5_sheetname);
        buffer.append("\n");
        buffer.append("[/BOUNDSHEET]\n");
