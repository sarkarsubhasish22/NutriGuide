...
final class ExpandedDouble {
    ...
    public ExpandedDouble(long rawBits) {
        ...
        if (biasedExp == 0) {
            ...
            this._binaryExponent = ((biasedExp & IEEEDouble.BIASED_EXPONENT_SPECIAL_VALUE) - 1023) - expAdj;
            return;
        }
        this._significand = getFrac(rawBits);
        this._binaryExponent = (biasedExp & IEEEDouble.BIASED_EXPONENT_SPECIAL_VALUE) - 1023;
    }
